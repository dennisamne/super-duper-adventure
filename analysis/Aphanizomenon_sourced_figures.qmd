...
pca_df %>%
  ...
  geom_point(size = 2) +
  geom_text(nudge_x = 0.023, size = 3, nudge_y = 0.005) +
...
SigInfo <- filtered_genes_and_paths_top50 %>%
 ...
 ggsave("../results/EcoGenes.pdf", width = 39, height = 16, units = "cm")
 
 ggsave("../results/EcoGenes.pdf",  width = 39, height = 39, units = "cm")
```
...
```{r}
#Keep Cobalamin, folate and Glutathione in Winter
